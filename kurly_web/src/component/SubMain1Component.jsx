...
export default function SubMain1Component () {
  ...
  React.useEffect=(()=>{
    axios({
      url:'../../public/data/new_product.json',
      method:'GET'
    })
    .then((res)=>{
                                   ...
                                   <div className="col-gap">`;
                                    <div className="wrap">`;
                                        <div className="img-box">`;
                                            <img src="./img/${상품이미지}" alt=""/>`;
                                            <a href="#" className='cart-btn'><img src="./img/${카트이미지}" alt=""/></a>`;
                                        </div>`;
                                        <div className="caption">`;
                                            <h6>${배송구분}</h6>`;
                                            <h2><strong>${제조사}</strong><em>${상품명}</em></h2>`;
                                            <h5>${상품정보}</h5>`;
                                            <h3>
                                                {
