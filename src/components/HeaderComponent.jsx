...
export default function HeaderComponent($path, $sub_path) {
  return (
    <header id="header">
    <div className="row1">
        <div className="row1-1">
            <ul id="topMenu" className="member-bar">
                <li><a href="!#" className="on">회원가입</a></li>
                <li><i>|</i></li>
                <li><a href="!#">로그인</a></li>
                <li><i>|</i></li>
        ...
        <div className="row1-2">
            <div className="left">
                <ul>
                    <li>
                        <h1>
                            <a href="!#"><img src={`${$path}img/header/logo_kurly.svg`} alt="컬리 홈"/><span>마켓컬리</span></a>
                        </h1>
                    </li>
                    <li>
                        <i>|</i>
    ...
    <div className="row2">
        <div className="row2-container">
            ...
            <div className="center">
                <nav id="nav">
                    <span><a href={`${$sub_path}main1/`}>신상품</a></span>
                    <span><a href={`${$sub_path}main2/`}>베스트</a></span>
                    <span><a href={`${$sub_path}main3/`}>알뜰쇼핑</a></span>
                    <span><a href={`${$sub_path}main4/`}>특가/혜택</a></span>
                </nav>
            </div>
            <div className="right">
                <a href="!#">
